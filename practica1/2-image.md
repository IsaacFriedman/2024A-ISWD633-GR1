...
Una imagen es un paquete independiente y ejecutable que incluye todo lo necesario para ejecutar una aplicación (todas sus dependencias), mientras que un contenedor es una instancia ejecutable de una imagen, que se ejecuta en un entorno aislado.
...
![Imagenes Listadas](imagenes/imagenesListadas.png)
